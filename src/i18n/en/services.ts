...
export const servicesTexts: Service = {
  ...
  services: [
    ...
    },
    {
      ...
      icon: '/icons/spa.svg',
      content: "<i>This is a <b>text</b> for demonstration purposes</i>, Lorem ipsum dolor<br> sit amet consectetur, adipisicing elit. Deleniti non eius corrupti recusandae repellat, nulla commodi amet modi delectus nam consectetur in tenetur molestias aliquid. Non voluptas esse amet voluptate! ",
      features: [
    ...
    {   
      ...
      icon: '/icons/renovation.svg',
      content: "This is a text for <b>demonstration</b> purposes, Lorem ipsum dolor sit amet consectetur, adipisicing elit. Deleniti non eius corrupti recusandae repellat, nulla commodi amet modi delectus nam consectetur in tenetur molestias aliquid.<br> Non voluptas esse amet voluptate! ",
      features: [
        'Beautiful waterfalls and fountains',
        'Custom designs and styles',
        'Enhanced aesthetics and functionality'
